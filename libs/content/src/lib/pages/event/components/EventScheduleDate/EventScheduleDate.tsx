...
import { CommonBoxWithNumber, DatePicker, TitleSubTitle } from "@platformx/utilities";
import React from "react";
import { useTranslation } from "react-i18next";
import { useCustomStyle } from "../../CreateEvent.styles";
import { ScheduleProp } from "../../CreateEvent.types";

const EventScheduleDate = ({ state, setState, unsavedChanges }: ScheduleProp) => {
