      ...
      <Box
          ...
          <Box
            ...
            <Box sx={{ position: "relative", width: "100%" }}>
              ...
              <Box sx={{ visibility: eventState === "live" ? "initial" : "hidden" }}>
                <img src={liveIcon} className='eventLiveIcon' alt='liveIcon' />
              </Box>
            </Box>
            <Box sx={{ margin: "12px 18px 5px 18px" }}>
              ...
              <Typography variant='h6regular' component='p' className='eventDescription'>
        ...
        <Box
          ...
          <Button
            ...
            size='large'
            endIcon={<ArrowForwardIosOutlinedIcon className='eventArrowIcon' />}
