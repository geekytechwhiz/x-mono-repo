...
import { TitleSubTitle, TextBox, AutoTextArea } from "@platformx/utilities";
...
const SpaceDetails = ({ stateSpace, setStateSpace }) => {
  ...
  return (
    <Box id='titleDescription' className={`${classes.container} main-container`}>
      <TitleSubTitle
      ...
      <Grid container rowSpacing={1}>
        ...
        <Grid item xs={12} sm={7} md={7} className='margintopClassforSpaceDetails'>
          <TextBox
            name='displayName'
        ...
        <Grid item xs={12} sm={7} md={7} className='margintopClassforSpaceDetails'>
          <FormControl fullWidth disabled={readOnly}>
            <InputLabel id='demo-simple-select-label'>{t("template")}</InputLabel>
            <Select
