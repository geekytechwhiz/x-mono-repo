...
export const socialShareNameLength = 250;
export const socialShareDescriptionLength = 1000;
export const socialSharePreviewNameLength = 166;
export const socialSharePreviewDescriptionLength = 78;
