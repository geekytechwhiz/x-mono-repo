...
import EcomSearchBox from "./EcomSearch/EcomSearchBox";
import { useTranslation } from "react-i18next";
import DoneIcon from "@mui/icons-material/Done";
import { Drawer, Grid, Typography, Fab, Grow } from "@mui/material";
import CtaEditAndDone from "./CtaEditAndDone/CtaEditAndDone";
...
const EComTopHeading = (_props: eComTopHeadingprops) => {
  ...
  return (
    <Box className='ecommerce-topbar' sx={{ background: ThemeConstants.WHITE_COLOR }}>
      {/* {Large view design} */}
      <Grid
        container
        pt={2}
