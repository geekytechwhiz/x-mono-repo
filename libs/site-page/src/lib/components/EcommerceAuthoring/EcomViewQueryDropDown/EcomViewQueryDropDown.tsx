...
const EcomViewQueryDropDown = ({ filterData, stateManage = {} }: any) => {
  ...
  const filterQueryAdd = (filteredNames = [], searchTerm1 = "") => {
    if (nullToArray(filteredNames).length > 0 && ("" + searchTerm1).length > 0) {
  ...
  return (
    <Box component='span' className='ecommerce-dropdown-custom'>
      <ButtonGroup
        ...
        <Button
          sx={{ paddingRight: "30px", color: ThemeConstants.BLUE_COLOR, textTransform: "none" }}>
