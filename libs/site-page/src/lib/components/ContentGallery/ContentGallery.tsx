...
import { NoResults, ThemeConstants, AUTH_INFO, NoContentFound } from "@platformx/utilities";
import { fetchAllMultislotContentList } from "@platformx/authoring-apis";
import {
  ContentGalleryTypes,
  ContentGalleryTypes1,
  ContentProps,
} from "./utils/contentGalleryTypes";

const contentReturn = (fromPage = "", contentType: string[] = []) => {
      ...
      <Grid
        ...
        <Grid
          ...
          <Box justifyContent='end'>
            <Button variant='secondaryButton' onClick={() => onToggleContentGallery(-1)}>
              {t("cancel")}
            </Button>
