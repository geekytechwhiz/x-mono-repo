...
import { nullToArray } from "@platformx/utilities";
        ...
        <Accordion
          ...
          <AccordionSummary
            ...
            {tagCount > 0 ? (
              ...
              <Typography variant='h6medium'>{categoriesdata.category}</Typography>
            )}
          </AccordionSummary>
          <AccordionDetails
            sx={{
              ...
              ?.map((tag, index1) => {
                return (
                  <ListItem
                    ...
                    />
                    {count === index1 + 1 && categoriesdata.tags.length > count && (
                      <Typography
                        onClick={() => setViewMoreTagCount(categoriesdata.tags.length)}
                        variant='h7regular'
                        sx={{
                          color: "#374fd5",
