...
const ListView = ({
  ...
  const handleChange = (ischecked: boolean) => {
    const dialogContent = {
      ...
      isOpen: true,
      title: ischecked ? t("disable_workflow_title") : t("enable_workflow_title"),
      subTitle: ischecked
            ...
            <Box className='d-flex align-items-center'>
              ...
              <Box>
                <Box
                  ...
                  <Typography variant='h5semibold' className={classes.onHoverHighlight}>
                    {name}
                  </Typography>
                </Box>
                ...
                <Box
                  ...
                  <Box>
                    <Typography variant='h7regular' sx={{ display: { xs: "flex", em: "none" } }}>
                      {DateTime}
                    </Typography>
                  </Box>
                </Box>
          ...
          <Grid xs={1} em={4}>
            <Box className='d-flex align-items-center justify-content-end'>
              ...
              <Box color='#89909A' className='d-inline-flex align-items-center'>
                <Box className='d-flex align-items-center'>
                  <MenuItem className='icons' onClick={() => handleViewWorkflow(id)}>
