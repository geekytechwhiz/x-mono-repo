                  ...
                  <Grid item xs={7} sm={7} md={7}>
                    <Grid container>
                      <Grid item xs={12}>
                        <Box sx={{ display: "flex" }}>
                          <BasicSwitch
                            checked={feature.article || feature.quiz || feature.vod || feature.poll}
                            onChange={() => masterControl()}
                            color={ThemeConstants.BLACK_COLOR}
                          />
                          <Box className={classes.subtitle}>
                            <Typography variant='h5regular' sx={{ textTransform: "capitalize" }}>
                              {t("master_control")}
                            </Typography>
                            <Typography variant='h7regular' sx={{ textTransform: "capitalize" }}>
                              {t("master_control")}
                            </Typography>
                          </Box>
                        </Box>
                      ...
                      <Grid item xs={12}>
                        <Box sx={{ display: "flex" }}>
                          <BasicSwitch
                            ...
                            color={ThemeConstants.BLACK_COLOR}
                          />
                          <Typography variant='h5regular' className={classes.subtitle2}>
                            {t("article")}
                          </Typography>
                        </Box>
                      </Grid>
