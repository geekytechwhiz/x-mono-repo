...
const RolePermissions = ({ t, roleSelected, setRoleSelected, state, setState }: any) => {
  const [runFetchRolesList] = useLazyQuery(UserManagementQueries.FETCH_PERMISSION_LIST);
