          ...
          <Grid container>
            <Grid item xs={12} md={12} em={8}>
              <Box
                ...
                <Box
                  ...
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    <Typography variant='h3bold' component='div' sx={{ marginRight: "5px" }}>
                      Prakash Raj
                    </Typography>
                    <Box
                      sx={{
            ...
            <Grid item xs={12} md={12} em={4}>
              <Box className='UserDetailssc'>
                <Typography variant='h5regular' sx={{ display: "flex", alignItems: "center" }}>
                  <MailOutlineIcon sx={{ marginRight: "12px", fontSize: "18px" }} />
                  rkaushal@hello.com
                </Typography>
                <Typography variant='h5regular' sx={{ display: "flex", alignItems: "center" }}>
                  <LocalPhoneIcon sx={{ marginRight: "12px", fontSize: "18px" }} />
                  123 445 7890
                </Typography>
                <Typography variant='h5regular' sx={{ display: "flex", alignItems: "center" }}>
                  <AccessTimeIcon sx={{ marginRight: "12px", fontSize: "18px" }} />
