...
export const useSnowplowTrackingHook = () => {
  ...
  const pageImpressionsObject = async (
    ...
    console.log("snowplow1", publicRuntimeConfig.NEXT_PAGE_IMPRESSIONS_SCHEMA);
    console.log("snowplow2", SNOWPLOW.TRACKID);
    console.log("snowplow3", snowplowObj);
