...
function MenuCreationFirstPage({
  ...
  const [, setLinkMenuItemName] = useState("");
  const [, setMenu] = React.useState("");
  const [subMenuValue, setSubMenuValue] = React.useState("No Menu Item Selected");
  ...
  const handleMenuChange = (evnt) => {
    ...
    if (evnt.target.value === "Main Menu") setSubMenuValue("No Menu Item Selected");
  };
        ...
        <Box
          ...
          <Box>
            ...
            <Box
              ...
              <Box sx={{ paddingTop: 1, pr: 1 }}>
                <TextField
                  ...
                  sx={{ fontSize: ThemeConstants.FONTSIZE_XS }}></TextField>
              </Box>
            </Box>
            <Box
              sx={{
            ...
            <Box sx={{ ml: "11px", marginTop: "25px" }}>
              ...
              <Box sx={{ pr: 1, pb: "17px" }}>
                <Typography
                  onClick={() => (radioSelected === "Sub Menu" ? setOpen(true) : null)}
                  sx={{
                    ...
                    color:
                      radioSelected === "Main Menu" || subMenuValue === "No Menu Item Selected"
                        ? "#ced3d9"
                        : "#2d2d39",
                  }}>
                  {subMenuValue}
