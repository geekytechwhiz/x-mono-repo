        ...
        <Box
          ...
          <Box
            ...
            <Box sx={{ margin: "0 auto 10px" }}>
              <img src={LadyImage} width='301px' height='218px' alt='icon'></img>
            </Box>
            <Box>
              ...
              <ErrorTooltip
                component={
                  <Button
                    ...
                    <AddIcon sx={{ width: "14px", height: "14px", mr: "8px" }} />
          ...
          <Box
            ...
            <Box sx={{ alignItems: "center" }}>
              ...
              <Box sx={{ margin: "39px 0 23px", objectFit: "contain" }}>
                <img src={GuidelineImage} width='695px' alt='icon' />
              </Box>
              <Box
                sx={{
                  marginBottom: "14px",
