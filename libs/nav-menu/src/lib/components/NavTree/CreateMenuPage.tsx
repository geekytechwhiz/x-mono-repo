...
import { RootState, addMenu } from "@platformx/authoring-state";
...
function CreateMenuPage({
  ...
  const [, setIsContinueLink] = useState(false);
  ...
  const onEdit = () => {
    ...
    const currentTab =
      alignment === "Page" ? true : radioSelectedLink === t("current_tab") ? true : false;
    const menuToSend = {
      Tagging: "Navigation",
      Description: menuDescription,
          ...
          <Box sx={{ overflowX: "hidden" }}>
                ...
                <Box>
                  <Grid container sx={{ mb: 5 }}>
                    <Grid sx={{ px: 1 }} xs={12} md={5} lg={4}>
                      ...
                      <Typography component='div' variant='h7regular' sx={{ color: "#89909a" }}>
                        {" "}
                        {t("menu_subname")}
                      </Typography>
                    </Grid>
                        ...
                        return (
                          <img
                            ...
                            style={{
                              ...
                              padding: "5px",
                              marginRight: "3px",
                              border: selectedIcon === icon.url ? "solid 1px #ced3d9" : "none",
                              backgroundColor: selectedIcon === icon.url ? "#f5f6f8" : "#fff",
                              borderRadius: "5px",
                            }}
                          />
                        );
                        ...
                        <FormControl fullWidth>
                          <Select
                            ...
                            sx={{
                              ...
                              fontSize: ThemeConstants.FONTSIZE_SM,
                              color: menu === "No Menu Item Selected" ? "#ced3d9" : "#2d2d39",
                            }}
                            value={menu}
                  ...
                  <Grid container sx={{ mb: 5 }}>
                    <Grid sx={{ px: 1 }} xs={12} md={5} lg={4}>
                      <Typography variant='h6medium' sx={{ textTransform: "capitalize" }}>
                        {" "}
                        {t("menu_content")}
                      </Typography>
                    </Grid>
              ...
              <Box
                ...
                {menuDescription && (
                  <Grid container sx={{ mb: 5, alignItems: "center" }}>
                    ...
                    <Grid sx={{ px: 1 }} xs={12} md={7} lg={8}>
                      <Typography variant='h6bold'>{menuDescription}</Typography>
                    </Grid>
                  </Grid>
                )}
                {selectedIcon && (
                ...
                <Grid container sx={{ mb: 5, alignItems: "center" }}>
                  <Grid sx={{ px: 1 }} xs={12} md={5} lg={4}>
                    <Typography variant='h6medium'> {t("menu_item_type")}</Typography>
                  </Grid>
                  <Grid sx={{ px: 1 }} xs={12} md={7} lg={8}>
                ...
                {menu !== "No Menu Item Selected" && (
                  <Grid container sx={{ mb: 5, alignItems: "center" }}>
                    <Grid sx={{ px: 1 }} xs={12} md={5} lg={4}>
                      <Typography variant='h6medium'> {t("menu_item_selected")}</Typography>
                    </Grid>
                    <Grid sx={{ px: 1 }} xs={12} md={7} lg={8}>
                ...
                <Grid container sx={{ mb: 5, alignItems: "center" }}>
                  ...
                  <Grid sx={{ px: 1 }} xs={12} md={7} lg={8}>
                    <Typography variant='h6bold'>{radioSelectedLink}</Typography>
                  </Grid>
                </Grid>
                {selectedItem.Title !== "" && (
                  <Grid container>
            ...
            {activeStep === 1 || activeStep === 2 ? (
              <Box
                ...
                <Button
                  disableElevation
                  disabled={(linkMenuItemName && menuItemName) || pageName1 ? false : true}
                  onClick={() => {
                    onConfirm();
                  }}
                  variant='contained'>
                  {activeStep === 2 ? (
                    <DoneOutlinedIcon sx={{ marginRight: "5px", width: "14px", height: "14px" }} />
                  ) : null}
                  {activeStep === 2 ? (isedit ? "Update" : t("confirm")) : t("continue")}
                  {activeStep === 2 ? null : (
                    <ArrowForwardIosIcon sx={{ width: "10.6px", height: "10.6px", ml: "5px" }} />
                  )}
                </Button>
              </Box>
            ) : (
