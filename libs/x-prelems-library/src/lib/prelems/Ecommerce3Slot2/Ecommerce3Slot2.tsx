...
const Ecommerce3Slot2 = ({
  ...
  const onCardClick = (index: number) => {
    const url = `${secondaryArgs?.prelemBaseEndpoint?.PublishEndPoint}${secondaryArgs?.prelemBaseEndpoint?.language}/ecommerce/product-listing`;
...
Ecommerce3Slot2.defaultProps = {
  ...
  analytics: {
    ...
    pageTags: "Ecommerce 3 slot2, Article Prelem, Media Cards",
    prelemTags: "Ecommerce 3 slot2, Article Prelem, Media Cards",
  },
  secondaryArgs: {
    prelemBaseEndpoint: {
