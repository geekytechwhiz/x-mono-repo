                    ...
                    <Box sx={{ display: "flex" }}>
                      ...
                      <Typography variant='h6regular' sx={{ paddingRight: "10px" }}>
                        ...
                        <a
                          className='addressArea'
                          rel='noopener noreferrer'
                          href={`http://maps.google.com/?q=${nullToString()}, ${commaSeparated(
                            content?.locality,
                          )}, ${commaSeparated(content?.region_state)}, ${commaSeparated(
                            content?.country,
                          )}, ${commaSeparated(content?.postal_code)}`}
                          target='_blank'>
                          {`${commaSeparated(content?.actual_address)} ${commaSeparated(
                            content?.locality,
                          )} ${commaSeparated(content?.region_state)} ${commaSeparated(
                            content?.country,
...
EventDetails.defaultProps = {
  content: {
    postal_code: "6000012",
    country: "chennai4",
    region_state: "chennai3",
    locality: "chennai1",
    actual_address: "chennai",
  },
};
