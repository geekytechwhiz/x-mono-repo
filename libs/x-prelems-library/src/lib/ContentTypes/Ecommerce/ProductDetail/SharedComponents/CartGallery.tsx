...
import { convertToLowerCase, nullToObject, fallBackImage } from "@platformx/utilities";
    ...
    <Grid
      ...
      <Grid
        ...
        <Card className={`detail-large-image-card largeImageGap`}>
          <CardActionArea onClick={handleLargeImageClick} className={`large-image cardActionArea`}>
            <CardMedia
              className='skeleton'
